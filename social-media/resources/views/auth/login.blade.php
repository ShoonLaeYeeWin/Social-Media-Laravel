...
<div class="container inner">
  ...
  <div class="alert alert-success alert-dismissible fade show" role="alert">
    ...
    <button type="button" class="close ms-3 p-0" data-dismiss="alert" aria-label="Close">
      <i class="fa-sharp fa-solid fa-xmark"></i>
    </button>
  </div>
  @endif
  ...
  <p class="register-link">Don't have an account?<a href="{{ url('/auth/register') }}" class="reg-route"> Register
      Here!</a></p>
</div>
