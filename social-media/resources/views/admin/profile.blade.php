...
@section('head')
    ...
    <aside id="sidebar" class="sidebar">
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed {{ request()->routeIs('list.user') ? 'active' : '' }}"
                    data-bs-target="#tables-nav" data-bs-toggle="collapse" href="{{ route('list.user') }}">
    ...
    <div class="wrapper d-flex justify-content-center align-items-center vh-100">
        <div class="profile-blk shadow-lg pb-5 border border-dark w-50">
            @if (session('updateSuccess'))
                <div class="alert alert-success alert-dismissible fade show mt-5 mb-3 m-auto w-75 text-center"
                    role="alert">
            ...
            <div class="row d-flex justify-content-center">
                ...
                <div class="info-blk w-75 d-flex flex-column justify-content-center">
                    ...
                    <div class="mt-2 d-flex justify-content-between">
                        <h5>Photo:</h5>
                        @if (Auth::guard('admin')->user()->photo == null)
                            <img src="{{ asset('img/img_emptyProfile.png') }}" alt=""
                                style="max-width: 100px;height: 100px;object-fit: cover;">
                        @else
                            <img src="{{ asset('storage/' . Auth::guard('admin')->user()->photo) }}" alt=""
                                style="max-width: 100px;height: 100px;object-fit: cover;">
                        @endif
                    </div>
                </div>
